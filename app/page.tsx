...
export default function Home() {
    return (
        <main className="flex h-full min-h-screen flex-col items-center  text-white ">
            ...
            <section className="bg-zinc-50 w-full min-h-14 py-10 px-5 text-zinc-900 flex gap-4 flex-wrap justify-center items-center">

                {
                    LandingPageBoxes.map((box) => (
                        <div className="px-5 py-4 flex flex-col gap-5 rounded-lg shadow-md w-[30rem] text-white bg-[#00223b]">
